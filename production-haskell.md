...
<form action="https://productionhaskell.us19.list-manage.com/subscribe/post?u=a0a638df663bda1d7215d110f&amp;id=21562dcad9" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
    <div id="mc_embed_signup_scroll">
	<label for="mce-EMAIL">Subscribe to Production Haskell Updates</label>
	<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="email address" required>
    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_a0a638df663bda1d7215d110f_21562dcad9" tabindex="-1" value=""></div>
