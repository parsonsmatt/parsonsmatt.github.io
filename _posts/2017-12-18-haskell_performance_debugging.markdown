...
![The outpput of -hd](treap-base-hd)
...
![The output of -hd](treap-strict-nodes.png)
...
![heap output with strict spine](treap-strict-spine.png)
...
![Output of -hc](treap-strict-tuple-hc.png)
...
![heap profile after foldl'](treap-foldl.png)
...
![heap profile with only foldl](treap-just-foldl.png)
